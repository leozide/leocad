...
- LeoCAD for Windows:
  ...
  Download `LeoCAD-Windows-*.exe` to your computer, double click on the 
...
- LeoCAD for Linux and FreeBSD:
  ...
  `LeoCAD-Linux-*.AppImage` and run it instead.
...
- LeoCAD for macOS:
  ...
  Download `LeoCAD-macOS-*.dmg` to your computer, double click on the 
