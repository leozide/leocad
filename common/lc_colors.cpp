...
lcColor lcColorList[] =
{
	...
	{  34, { 0.4000f, 0.2627f, 0.0078f, 0.5020f },  true, "Trans Green" },
...
int lcNumUserColors = sizeof(lcColorList)/sizeof(lcColorList[0]) - 3;
int lcNumColors = sizeof(lcColorList)/sizeof(lcColorList[0]);
