...
static LC_MFW_PIECEINFO mfw_pieceinfo[] =
{
	...
	{ "30171", "Cap Aviator",                     LC_MFW_HAT, 0.0f, 0.0f, 3.84f, 0.0f, 0.0f, 0.0f },
...
//  { "2587", "Armour Plate",                LC_MFW_NECK, 0.0f, 0.0f, 2.96f, 0.0f, 0.0f, 0.0f }, // wrong height
//  { "2610", "Lifevest",                    LC_MFW_NECK, 0.0f, 0.0f, 2.96f, 0.0f, 0.0f, 0.0f }, // wrong height
	...
	{ "972P3J", "Left Leg with Grass Skirt",                LC_MFW_LEFT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "972P4F", "Left Leg with Leather Straps (Red Studs)", LC_MFW_LEFT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "972P63", "Left Leg with Robot Pattern",              LC_MFW_LEFT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "972PA2", "Left Leg with Green Kilt and Toes",        LC_MFW_LEFT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },

	// Right Legs
	{ "971",    "Right Leg",                                 LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "971P3J", "Right Leg with Grass Skirt",                LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "971P4F", "Right Leg with Leather Straps (Red Studs)", LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "971P63", "Right Leg with Robot Pattern",              LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "971PA2", "Right Leg with Green Kilt and Toes",        LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
	{ "971PS5", "Right Leg with SW Gunbelt",                 LC_MFW_RIGHT_LEG, 0.0f, 0.0f, 1.12f, 0.0f, 0.0f, 0.0f },
