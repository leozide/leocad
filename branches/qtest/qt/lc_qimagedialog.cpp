...
{
	QString result = QFileDialog::getOpenFileName(this, tr("Save Image File"), ui->fileName->text(), tr("Supported Files (*.bmp *.gif *.png *.jpg);;BMP Files (*.bmp);;GIF Files (*.gif);; PNG Files (*.png);;JPEG Files (*.jpg);;All Files (*.*)"));
