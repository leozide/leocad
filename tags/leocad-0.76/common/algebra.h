...
#define LC_MATH_FLOAT 1
//#define LC_MATH_SSE 1

#if !LC_MATH_FLOAT && !LC_MATH_SSE
#error No math type defined.
#endif
...
inline Vector3::Vector3(const Vector3& a)
...
// Cross product.
inline Vector3 Cross(const Vector4& a, const Vector4& b)
{ Vector3 res; lcBaseVector_Cross3(res.v, a.v, b.v); return res; }

inline Vector3 Cross(const Vector3& a, const Vector4& b)
{ Vector3 res; lcBaseVector_Cross3(res.v, a.v, b.v); return res; }

inline Vector3 Cross(const Vector4& a, const Vector3& b)
{ Vector3 res; lcBaseVector_Cross3(res.v, a.v, b.v); return res; }
...
bool BoundingBoxRayMinIntersectDistance(const BoundingBox& Box, const Vector3& Start, const Vector3& End, float* Dist, Vector3* Intersection = NULL);
