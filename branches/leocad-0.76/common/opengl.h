...
inline int GL_GetMultiTextures()
{
	extern GLint GL_MultiTextures;
	return GL_MultiTextures;
}

inline bool GL_HasCompiledVertexArrays()
{
	extern bool GL_CompiledVertexArrays;
	return GL_CompiledVertexArrays;
}

inline bool GL_HasClampToEdge()
{
	extern bool GL_ClampToEdge;
	return GL_ClampToEdge;
}

inline bool GL_HasPointParameters()
{
	extern bool GL_PointParameters;
...
#define glBindBufferARB pfnglBindBufferARB
#define glDeleteBuffersARB pfnglDeleteBuffersARB
#define glGenBuffersARB pfnglGenBuffersARB
#define glIsBufferARB pfnglIsBufferARB
#define glBufferDataARB pfnglBufferDataARB
#define glBufferSubDataARB pfnglBufferSubDataARB
#define glGetBufferSubDataARB pfnglGetBufferSubDataARB
#define glMapBufferARB pfnglMapBufferARB
#define glUnmapBufferARB pfnglUnmapBufferARB
#define glGetBufferParameterivARB pfnglGetBufferParameterivARB
#define glGetBufferPointervARB pfnglGetBufferPointervARB
